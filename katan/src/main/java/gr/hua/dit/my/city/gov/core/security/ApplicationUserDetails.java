...
public final class ApplicationUserDetails implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        final String role;
        if (this.type == PersonType.ADMIN) role = "ROLE_ADMIN";
        else if (this.type == PersonType.CITIZEN) role = "ROLE_CITIZEN";
        else if (this.type == PersonType.EMPLOYEE) role = "ROLE_EMPLOYEE";
